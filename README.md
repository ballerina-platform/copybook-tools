...
| -n, --root-name               | The `root-name` parameter specifies the root record type name. If the `root-name` flag is not specified, the `copybook` tool will use the Copybook definition file name as the root type name.                                                                               |
